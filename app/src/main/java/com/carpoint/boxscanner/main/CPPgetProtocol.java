...
public class CPPgetProtocol extends AsyncTask<Boolean, Boolean, String> {
    ...
    private JSONObject productNaS;
    private OnFinish onFinish;

    public CPPgetProtocol(Context context, JSONObject product, OnFinish onFinish ) {
        mContext = context;
        productNaS = product;
    ...
    protected String doInBackground(Boolean... booleans) {
        try {
            ...
            writeText(os, "ids", productNaS.toString());
