...
public class CPPgetErrorListProtocol extends AsyncTask<Boolean, Boolean, String> {
    ...
    public CPPgetErrorListProtocol(Context context, OnFinish onFinish ) {
        mContext = context;
